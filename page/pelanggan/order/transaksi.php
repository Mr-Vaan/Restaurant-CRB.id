                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><a
                                                        href="?page=indexTransaksi&getItem&kd=<?=$data['kd_order']?>&kd_meja=<?= $data['no_meja'] ?>"><?=$data['kd_order']?></a>
                                                </td>
                                                <td><?=$data['no_meja']?></td>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" style="font-weight: bold; color: red;" class="form-control"
                                        name="kode_transaksi" value="<?php echo $autokode; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="">Kode Order</label>
                                    <input type="text" style="font-weight: bold; color: red;" readonly
                                        class="form-control" value="<?=$kd_order;?>">
                                </div>
                                <div class="form-group">
                                    <label for="">Total Harga</label>
                                    <input type="number" id="total" class="form-control form-control-md"
                                        name="total_harga" value="<?=$assoc['sub']?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control form-control-md" name="kembalian"
                                        id="kembalian">
                                </div>
                            </div>
