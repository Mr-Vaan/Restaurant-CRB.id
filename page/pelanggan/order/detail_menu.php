<?php
	...
	//For view keranjang
	$sql3     = "SELECT tb_order FROM kd_order WHERE no_meja='$no_meja2'";
	...
	$sql2  = "SELECT SUM(sub_total) as sub FROM tb_detail_order WHERE order_kd = '$data_kd2'";
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="keterangan" rows="3"
                                placeholder="Contoh : Untuk gado gado ga pake mentimun, ayam serundeng banyakin bumbunya"><?= $dk = null; ?></textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="au-breadcrumb-left">
                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                            ...
                            <li class="list-inline-item">
                                <a href="?page=order_menu&kategori&menu&kd=<?= $getKategori['kd_kategori'] ?>"><?= $getKategori['name_kategori'] ?>
                                </a>
                            </li>
                            <li class="list-inline-item"><span><i class="zmdi zmdi-chevron-right"></i></span></li>
                            ...
                            <div class="col-md-6">
                                <div class="card-body">
                                    <form action="" method="post">
                                        ...
                                        <hr>
                                        <h2 style="color: red;">Rp. <span id="harba"><?= $getMenu['harga']; ?></span>
                                        </h2>
                                        <hr>
